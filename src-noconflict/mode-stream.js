ace.define(
  ...
  [
    ...
    "ace/mode/text",
    "ace/tokenizer",
    "ace/mode/stream_highlight_rules",
    "ace/range",
  ],
  function (require, exports, module) {
    ...
    var StreamHighlightRules =
      require("./stream_highlight_rules").StreamHighlightRules;
    var Range = require("../range").Range;

    var Mode = function () {
      this.$tokenizer = new Tokenizer(new StreamHighlightRules().getRules());
    };
...
ace.define(
  ...
  function (require, exports, module) {
    ...
    var StreamHighlightRules = function () {
      var keywords =
    ...
    oop.inherits(StreamHighlightRules, TextHighlightRules);
    exports.StreamHighlightRules = StreamHighlightRules;
  }
);
